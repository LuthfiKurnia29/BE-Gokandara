...
Route::middleware('auth:sanctum')->get('konsumen-export-optimized', [KonsumenController::class, 'exportOptimized']);
...
Route::middleware('auth:sanctum')->post('projek/{id}/logo', [ProjekController::class, 'addLogo']);
...
Route::middleware('auth:sanctum')->get('get-statistik-konsumen', [AnalisaController::class, 'getStatistikKonsumen']);
